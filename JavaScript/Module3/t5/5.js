...
// All the elements
let article, header, figure, img, figcaption, p;
for (let pic of picArray){
  article = document.createElement("article")
  article.setAttribute("class", "card")

  header = document.createElement("h2")
      .appendChild(document.createTextNode(`${pic["title"]}`));
  ...
  figcaption = document.createElement("figcaption")
      .appendChild(document.createTextNode(`${pic["caption"]}`))
  figure.appendChild(img)
  figure.appendChild(figcaption)

  p = document.createElement("p")
      .appendChild(document.createTextNode(`${pic["description"]}`))
